# HongFu Release Package v28.0.0

This release package was generated from private source repository `sydneypoole/hongfu` at commit `f9b344469a50b1bbff14e8d127a89470f1f88439`.
It contains deployment artifacts only and does not include application source code.

## Image

```text
ghcr.io/sydneypoole/hf:v28.0.0
```
