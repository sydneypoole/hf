# HongFu Release Package v17.0.0

This release package was generated from private source repository `sydneypoole/hongfu` at commit `86deac99d89e01ecad6a8802dfd85003d49e814a`.
It contains deployment artifacts only and does not include application source code.

## Image

```text
ghcr.io/sydneypoole/hf:v17.0.0
```
