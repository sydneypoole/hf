# HongFu Release Package v24.0.0

This release package was generated from private source repository `sydneypoole/hongfu` at commit `40ccbb9bf5313c8c3f3efad4693a950b7f82232b`.
It contains deployment artifacts only and does not include application source code.

## Image

```text
ghcr.io/sydneypoole/hf:v24.0.0
```
