# HongFu Release Package v2.0.2

This release package was generated from private source repository `sydneypoole/hongfu` at commit `0f03bb1391c5d1cc7a3653e13e47f1ed1c4503cc`.
It contains deployment artifacts only and does not include application source code.

## Image

```text
ghcr.io/sydneypoole/hf:v2.0.2
```
