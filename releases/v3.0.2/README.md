# HongFu Release Package v3.0.2

This release package was generated from private source repository `sydneypoole/hongfu` at commit `25f3e789d264e1890bd2727e7d1b7c7a6cb53db3`.
It contains deployment artifacts only and does not include application source code.

## Image

```text
ghcr.io/sydneypoole/hf:v3.0.2
```
