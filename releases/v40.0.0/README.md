# HongFu Release Package v40.0.0

This release package was generated from private source repository `sydneypoole/hongfu` at commit `0f9f18f106a4f94726794ac010beaed013cb3858`.
It contains deployment artifacts only and does not include application source code.

## Image

```text
ghcr.io/sydneypoole/hf:v40.0.0
```
